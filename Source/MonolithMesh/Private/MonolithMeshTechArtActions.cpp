		...
		for (UStaticMeshComponent* SMC : SMCs)
		{
			...
			for (int32 SectionIdx = 0; SectionIdx < LOD0.Sections.Num(); ++SectionIdx)
			{
				...
				if (MatInterface)
				{
					...
					MatInterface->GetUsedTextures(UsedTextures, EMaterialQualityLevel::High, false, ERHIFeatureLevel::SM5, false);
#else
...
#if ENGINE_MAJOR_VERSION == 5 && ENGINE_MINOR_VERSION <= 4
					MatInterface->GetUsedTextures(Textures, EMaterialQualityLevel::High, false, ERHIFeatureLevel::SM5, false);
#else
